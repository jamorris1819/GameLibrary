...
namespace GameLibrary.Controls
{
    ...
    public class LinkPictureBox : Control
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                if (hoverImage == null)
                    spriteBatch.Draw(image, destinationRect, sourceRect, hasFocus ? HoverColor : Color);
                else if (hasFocus)
                    spriteBatch.Draw(hoverImage, destinationRect, hoverSourceRect, hasFocus ? HoverColor : Color);
                else
                    spriteBatch.Draw(image, destinationRect, sourceRect, hasFocus ? HoverColor : Color);
            }
        ...
        public override void HandleInput()
        {
            if (!hasFocus)
                return;
            if (InputHandler.MouseDown(ButtonPressed.Left))
